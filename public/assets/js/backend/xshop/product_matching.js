define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/product_matching/index?ids='+id,
                    add_url: 'xshop/product_matching/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/product_matching/edit',
                    del_url: 'xshop/product_matching/del',
                    multi_url: 'xshop/product_matching/multi',
                    table: 'xshop/product_matching',
                }
            });
