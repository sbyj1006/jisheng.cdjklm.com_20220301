define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/category_jz/index?ids='+id,
                    add_url: 'xshop/category_jz/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/category_jz/edit',
                    del_url: 'xshop/category_jz/del',
                    multi_url: 'xshop/category_jz/multi',
                    table: 'xshop/category_jz',
                }
            });
