define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/product_info/index?ids='+id,
                    add_url: 'xshop/product_info/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/product_info/edit',
                    del_url: 'xshop/product_info/del',
                    multi_url: 'xshop/product_info/multi',
                    table: 'xshop/product_info',
                }
            });
