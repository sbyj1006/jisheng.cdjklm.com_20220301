define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/product_banner/index?ids='+id,
                    add_url: 'xshop/product_banner/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/product_banner/edit',
                    del_url: 'xshop/product_banner/del',
                    multi_url: 'xshop/product_banner/multi',
                    table: 'xshop/product_banner',
                }
            });
