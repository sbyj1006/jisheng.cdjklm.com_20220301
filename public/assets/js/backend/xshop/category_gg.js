define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/category_gg/index?ids='+id,
                    add_url: 'xshop/category_gg/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/category_gg/edit',
                    del_url: 'xshop/category_gg/del',
                    multi_url: 'xshop/category_gg/multi',
                    table: 'xshop/category_gg',
                }
            });
