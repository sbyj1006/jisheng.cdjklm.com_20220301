define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url:  'xshop/product_images/index?ids='+id,
                    add_url: 'xshop/product_images/add/lineid/'+Config.lineid,
                    edit_url: 'xshop/product_images/edit',
                    del_url: 'xshop/product_images/del',
                    multi_url: 'xshop/product_images/multi',
                    table: 'xshop/product_images',
                }
            });
