...
class Myform extends Api
{
    ...
    public function huishouadd()
    {
        ...
        if($data){
            ...
            if($datas['user_name']){}else{
                $datas['user_name']=$data['userInfo']['nickname'];
            }
            $datas['statue']=1;
            ...
            if($datas['chetype_id']){
                $chetype= Db::name('categoryche')->where(array('id'=>$datas['chetype_id']))->order('rank desc')->find();

                $datas['chetype_id']=$chetype['id'];
                $datas['chetype_name']=$chetype['name'];
                $datas['dan_price']=$chetype['dan_price'];
                $datas['kouzabili']=$chetype['kouzabili'];
    ...
    public function jiesuanadd()
    {
        ...
        if($data){
            ...
            if(isset($data['ruchangbianhao'])) {
                ...
                //自动生成入场编号
                $datas['ruchangbianhao']='RC'.time().rand(1,9);
