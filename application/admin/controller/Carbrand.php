...
class Carbrand extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\common\model\Carbrand;
...
//                    }
                    ...
                    $newsdata=Db::name('car_brand')->order('bcode desc')->find();
                    $newsbcode=$newsdata['bcode']+1;
                    $params['bcode']=$newsbcode;
//        dump($newsbcode);
