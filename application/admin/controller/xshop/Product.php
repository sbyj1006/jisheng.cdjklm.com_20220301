...
class Product extends Base
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign("plate_typeList", $this->model->getPlate_typeList());
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
                $row->visible(['id','title','description','procode','price','itemnum','rukunum','content','image','on_sale','rating','sold_count','review_count','price', 'market_price', 'create_time', 'home_recommend', 'category_recommend', 'service_tags']);
