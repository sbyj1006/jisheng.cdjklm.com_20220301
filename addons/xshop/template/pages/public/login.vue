<template>
	<view class="container">
		...
		<view class="back-btn iconfont iconzuojiantou" @click="navBack"></view>
		...
		<view class="wrapper">
			...
			<view class="input-content">
				...
				<view class="input-item" v-if="loginWay == 0">
					...
					<input type="text" class="input" v-model="username" placeholder="请输入用户名/手机号码/邮箱" maxlength="11" data-key="input" />
				</view>
				<view class="input-item" v-if="loginWay == 0">
				...
				<view class="input-item" v-if="loginWay == 1">
					...
					<input type="number" class="input" value="" placeholder="请输入验证码" placeholder-class="input-empty" maxlength="8" password data-key="code"
			...
			<view class="third-party">
				<!-- #ifdef H5 -->
				<button @click="vendorLogin('WxH5')" class="btn">微信登录</button>
				<!-- #endif -->
				<!-- #ifdef MP-WEIXIN -->
				<button type="primary" class="btn" open-type="getUserInfo" @getuserinfo="onGotUserInfo">微信登录</button>
				<!-- #endif -->
				<!-- #ifdef APP-PLUS -->
				<button type="primary" class="btn" @click="vendorLogin('App5')">微信登录</button>
				<!-- #endif -->
			</view>
		</view>
	</view>
