...
class Base extends Api
{
    ...
    protected function _initialize()
    {
        $this->header = [
            ...
            'Access-Control-Allow-Headers' => 'Content-Type,Xshop-Token,platform,sid',
        ...
        $this->view = View::instance(['view_path' => ADDON_PATH . 'xshop' . DS . 'view' . DS]);
    }

    protected function checkNeedLogin()
    {
