...
class PackageService
{
    ...
    {
        $addonTmpDir = RUNTIME_PATH . 'addons' . DS . 'temp' . DS;
        ...
        $ret = Http::sendRequest(self::getServerUrl() . '/addons/xshopplugin/package/download', array_merge(['name' => $name], $extend), 'GET', $options);
        if ($ret['ret']) {
    ...
    {
        $file = RUNTIME_PATH . 'addons' . DS . 'temp' . DS . $name . '.zip';
...
EOD;
    ...
    {
        return get_addon_info('xshop')['api_url'];
    }
